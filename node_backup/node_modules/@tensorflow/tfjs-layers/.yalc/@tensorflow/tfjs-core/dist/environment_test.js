...
describe('Backend', function () {
    ...
    it('should reuse backend engine if has been instantiated', function () {
        var backend = new backend_cpu_1.MathBackendCPU();
        environment_1.ENV.registerBackend('custom', function () { return backend; });
        var backend2 = new backend_cpu_1.MathBackendCPU();
        environment_1.ENV.registerBackend('custom2', function () { return backend2; });
        environment_1.Environment.setBackend('custom');
        var engine1 = environment_1.ENV.engine;
        environment_1.Environment.setBackend('custom2');
        var engine2 = environment_1.ENV.engine;
        environment_1.Environment.setBackend('custom');
        var engine3 = environment_1.ENV.engine;
        expect(engine1).not.toBe(engine2);
        expect(engine1).toBe(engine3);
        environment_1.ENV.removeBackend('custom');
        environment_1.ENV.removeBackend('custom2');
    });
});
